...
const plants = computed(() => {
    ...
    return dashboardStore.listPlants
...
function getTranslatedName(plant: Dashboard.Plant): string {
    const index = language.value.name === 'ar-DZ' ? 1 : 0;
    return plant.translations[index];
}
</script>
